...
const CarSlide = memo<CarSlideProps>(
  ({ car, isActive, prevCar, nextCar, onOpenModal }) => {
    ...
    // ✅ Упрощенная функция инициализации Canvas
    ...
    return (
      ...
      >
        ...
        >
          <h1
            className='text-[18vw] md:text-[10vw] font-black tracking-wider select-none will-change-transform'
            style={{
        ...
        {/* Left Content */}
        <motion.div
          className='absolute left-4 md:left-16 top-[10%] z-10 max-w-xs md:max-w-sm'
        ...
        >
          ...
          <div className='flex gap-[7px]'>
            <motion.div
              className='t w-12 md:w-10 translate-y-[10px] h-0.5 bg-primary mb-3 md:mb-4'
              initial={{ width: 0 }}
              animate={{ width: '4rem' }}
          ...
          <motion.p
            className='text-[#747474] w-[60%] md:text-sm lg:text-[18px] leading-relaxed'
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          <div className='flex flex-col items-end gap-4 md:gap-6'>
            <div className='flex flex-col gap-2 md:gap-3'>
              <Button
                ...
                className='bg-transparent rounded-full border-primary text-primary hover:bg-white/10 backdrop-blur-sm transition-all duration-300 px-4 md:px-10 py-1.5 md:py-2 text-xs md:text-sm'
              >
                Rent a car
              </Button>
              <Button
                onClick={handleBuyClick}
                className='bg-primary text-black rounded-full hover:bg-yellow-500 transition-all duration-300 px-4 md:px-6 py-1.5 md:py-2 text-xs md:text-sm font-medium'
              >
                Buy a car
              </Button>
            </div>
        ...
        >
          <div className='flex flex-col md:flex-row justify-between items-start md:items-end'>
            <div className='mb-4 md:mb-0 max-w-md border-l-4 border-primary pl-4'>
              <h2 className='text-white text-2xl md:text-4xl font-bold mb-2 md:mb-3 tracking-wide'>
                {car.fullName}
              </h2>
              <p className='text-[#747474] text-xs md:text-sm leading-relaxed mb-2'>
                {car.description}
              </p>
            </div>
            <div className='flex gap-6 md:gap-12 text-white'>
              ...
              <div className='flex flex-col items-start'>
                <Settings className='w-4 md:w-10 h-4 md:h-10 text-gray-400 mb-1 md:mb-2' />
                <div className=' md:w-full h-[1px] bg-primary mb-1 md:mb-2'></div>
                <div className='flex items-center gap-1'>
                  <p className='text-sm md:text-2xl font-bold'>{car.mileage}</p>
                  <p className='text-[10px] md:text-sm text-gray-500 tracking-wider'>
                    MILEAGE
                  </p>
                </div>
              </div>
              {/* SPEED */}
              <div className='flex flex-col items-start'>
                <Zap className='w-4 md:w-10 h-4 md:h-10 text-gray-400 mb-1 md:mb-2' />
                <div className='md:w-full h-[1px] bg-primary mb-1 md:mb-2'></div>
                <div className='flex items-center gap-1'>
              ...
              {/* YEAR */}
              <div className='flex flex-col items-start'>
                <Calendar className='w-4 md:w-10 h-4 md:h-10 text-gray-400 mb-1 md:mb-2' />
                <div className='w-full h-[1px] bg-primary mb-1 md:mb-2'></div>
                <div className='flex items-center gap-1'>
                  <p className='text-sm md:text-2xl font-bold'>{car.year}</p>
                  <p className='text-[10px] md:text-sm text-gray-500 tracking-wider'>
                    YEAR
                  </p>
                </div>
            ...
            <div className='flex flex-col items-start md:items-end gap-4 md:gap-6'>
              <Button
                ...
                className='bg-primary rounded-full text-black hover:bg-yellow-500 transition-all duration-300 px-6 md:px-8 py-1.5 md:py-2 text-xs md:text-sm font-medium'
              >
                View details
              </Button>
            </div>
