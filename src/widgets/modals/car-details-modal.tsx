...
export function CarDetailsModal({
	...
	const specifications: Specification[] = [
		...
		{ icon: Gauge, label: 'Max Speed', value: `${car.maxSpeed} km/h` },
		{
			icon: Settings,
			label: 'Acceleration',
			value: `0-100 km/h in ${car.acceleration}`,
		},
	...
	const reviews: Review[] = [
		{
			...
			rating: 5,
			comment:
				'Absolutely incredible driving experience. The power and handling are phenomenal!',
			date: '2 weeks ago',
		},
		{
			name: 'Sarah Chen',
			rating: 5,
			comment:
				'Beautiful car with amazing attention to detail. Worth every penny.',
			date: '1 month ago',
		},
		{
			name: 'Mike Rodriguez',
			rating: 4,
			comment:
				'Great performance car, though fuel economy could be better for daily driving.',
			date: '2 months ago',
		},
	]
	...
	return (
		<Modal isOpen={isOpen} onClose={onClose} title='Car Details' size='xl'>
			<div className='p-6 space-y-8'>
				{/* Hero Section */}
				<motion.div
					className='relative h-64 bg-gradient-to-r rounded-xl overflow-hidden'
				...
				>
					...
					<div className='p-4 bg-gray-800 rounded-lg border border-gray-700'>
						...
						<p className='text-gray-400 mb-3'>
							123 Luxury Car Boulevard, City Center
						</p>
